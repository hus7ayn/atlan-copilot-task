...
class SentimentAgent:
    def __init__(self):
        ...
        print(f"🔍 SentimentAgent - API key has newline: {newline_char in self.api_key}")
        print(f"🔍 SentimentAgent - API key has carriage return: {carriage_return_char in self.api_key}")
